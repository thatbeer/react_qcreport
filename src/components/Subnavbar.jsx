...
const Subnavbar = (props) => {
  ...
  return (
    ...
    <>
        <div className='relatvie mx-auto  min-h-[30px]  border-b-2 border-blue-600 bg-gradient-to-r from-sky-300 via-blue-100 to-sky-300'>
            <div className='flex px-6 mx-auto pt-1  py-2 justify-center items-center '>
              ...
              >
                ...
                <div className='flex flex-1 items-center'>
                  ...
                  <div>
                  <FolderArrowDownIcon className='flex z-30 lg:relative h-8 w-8 mx-2 pr-2 text-red-500 
