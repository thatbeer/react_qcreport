...
const   ViewImage = () => {
  ...
  return (
    <div className= "relative lg:h-[200px]  h-auto w-auto  lg: mx-auto mt-0 lg:pt-0 lg:px-0">
        <h1 className='text-xl flex justify-center text-center font-bold mx-auto py-0 text-white bg-blue-500 border border-gray-600'>ภาพถ่าย</h1>
      <div className="">
        <Carousel infiniteLoop useKeyboardArrows
        onChange={onIndexChangeHandler} showArrows={true} showStatus={false}
        showThumbs={false} >
          <div className="lg:h-[350px] h-full w-full m-auto my-2 hover:cursor-pointer" onClick={() => {navigate('/img')}}>
