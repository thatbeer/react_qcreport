                ...
                <>
                    ...
                    <table className='w-full'>
                        ...
                        <tr className='  border border-x border-gray-600  '>
                            ...
                            <td className='px-2 py-1 w-2/5  lg:w-2/3 text-start text-white text-sm bg-green-400 '>1.2100</td>
                        </tr>
                        <tr className=' border-b border-x border-gray-600   '>
                            <th className='px-2 py-1 w-3/5  lg:w-1/3 text-start text-sm  border-r bg-green-100 border-gray-600'>2.ระดับพื้นดิน (ม.)</th>
                            <td className='px-2 py-1 w-2/5  lg:w-2/3 text-start text-white text-sm bg-green-400  '>1.1400</td>
                        </tr>
                        <tr className=' border-b border-x border-gray-600   '>
                            <th className='px-2 py-1 w-3/5  lg:w-1/3 text-start text-sm border-r bg-green-100 border-gray-600'>3.ระดับตัดหัวเสาเข็ม (ม.)</th>
                            <td className='px-2 py-1 w-2/5  lg:w-2/3 text-start text-white text-sm bg-green-400 '>-12.5500</td>
                        </tr>
                        <tr className=' border-b border-x border-gray-600   '>
                    ...
                    <table className='w-full'>
                        ...
                        <tr className='  border border-x border-gray-600  '>
                            ...
                            <td className='px-2 py-1 w-2/5  lg:w-2/3 text-start text-white text-sm bg-green-400  '>0.500</td>
                        </tr>
                        <tr className=' border-b border-x border-gray-600   '>
            ...
            <table className=" table-fixed lg:table-none w-full text-sm">
                ...
                <tbody className='2.บัคเก็ต '>
                        ...
                        <tr  className="text-center border-y border-gray-700 rounded-t  my-auto items-center justify-center">
                            ...
                            <td className='px-2 py-1 border-r border-gray-700 text-white bg-green-400'>68.600</td>
                            <td className='px-2 py-1 border-r border-gray-700 '>PR-25</td>
                            <td className='px-2 py-1 border-r border-gray-700 '>{' '}</td>
                            <td className='px-2 py-1 border-r border-gray-700 '>3 ม.ค. 2566 (14:00 - 14:40)</td>
                            <td className='px-2 py-1 border-r border-gray-700 '>บุญมี เชื้อตระกูล</td>
