        ...
        <div className='flex flex-col'>
            ...
            <table className='w-full'>
                ...
                <tr className='  border border-x border-white  '>
                    ...
                    <td className='px-2 py-1 text-sm w-1/2 lg:w-2/3 text-start bg-green-600 text-white '>30</td>
                </tr>
                <tr className='  border border-x border-white  '>
                ...
                <tr className='  border border-x   border-white  '>
                    ...
                    <td className='px-2 py-1 text-sm w-1/2 lg:w-2/3 text-start bg-green-600 text-white '>68.600</td>
                </tr>
                </tbody>
            </table>
            </div>
