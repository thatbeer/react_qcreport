            ...
            <div className='mx-auto w-full relative my-2'>
                ...
                <table className='w-full'>
                    ...
                    <tr className=' border border-x border-gray-600 items-center text-start justify-between '>
                        <th className='py-1 px-2 w-1/2 lg:w-1/3 border-r text-start text-sm bg-orange-200 border-gray-600'>ยี่ห้อคอนกรีต	</th>
                        <td className='py-1 px-2 w-1/2 lg:w-2/3 text-start '>โออาร์ซี</td>
                    </tr>
                    <tr className=' border border-x border-gray-600 items-center text-start justify-between '>
                        <th className='py-1 px-2 w-1/2 lg:w-1/3 border-r text-start text-sm bg-orange-200 border-gray-600'>Strength	</th>
                        <td className='py-1 px-2 w-1/2 lg:w-2/3 text-start '>350 CY</td>
                    </tr>
                    <tr className=' border border-x border-gray-600 items-center text-start justify-between '>
                        <th className='py-1 px-2 w-1/2 lg:w-1/3 border-r text-start text-sm bg-orange-200 border-gray-600'>MIX No.	</th>
                        <td className='py-1 px-2 w-1/2 lg:w-2/3 text-start '>PYB4026DC1</td>
                    </tr>
                    <tr className=' border border-x border-gray-600 items-center text-start justify-between '>
                        <th className='py-1 px-2 w-1/2 lg:w-1/3 border-r text-start text-sm bg-orange-200 border-gray-600'>ค่า Slump (ซม.)</th>
                        <td className='py-1 px-2 w-1/2 lg:w-2/3 text-start '>17.5 - 22.5</td>
                    </tr>
                    <tr className=' border border-x border-gray-600 items-center text-start justify-between '>
                        <th className='py-1 px-2 w-1/2 lg:w-1/3 border-r text-start text-sm bg-orange-200 border-gray-600'>ปริมาณคอนกรีตสะสม (ม3)</th>
              ...
              <table className=" w-auto">
                  ...
                  <tbody className='bg-gray-100 '>
                          <tr  className="text-center border-y border-gray-700   my-auto items-center justify-center">
                              ...
                              <td className='px-2 py-3 mx-auto my-1 text-sm  border-r border-gray-700 bg-green-300  '>20</td>
                              <td className='px-2 py-3 mx-auto my-1 text-sm  border-r border-gray-700   bg-green-300 '>
                                26 ธ.ค. 65
                                <pre>(14:30)</pre>
                              </td>
                              <td className='px-2 py-3 mx-auto my-1 text-sm  border-r border-gray-700   bg-green-300 '>
                          ...
                          <tr  className="text-center border-y border-gray-700   my-auto items-center justify-center">
                              ...
                              <td className='px-2 py-3 mx-auto my-1 text-sm  border-r border-gray-700  bg-green-300 '>19.0</td>
                              <td className='px-2 py-3 mx-auto my-1 text-sm  border-r border-gray-700   bg-green-300 '>
                                26 ธ.ค. 65
                                <pre>(14:30)</pre>
                              </td>
                          ...
                          <tr  className="text-center border-y border-gray-700   my-auto items-center justify-center">
                              ...
                              <td className='px-2 py-3 mx-auto my-1 text-sm  border-r border-gray-700  '>6.00</td>
                              <td className='px-2 py-3 mx-auto my-1 text-sm  border-r border-gray-700  bg-green-300 '>19</td>
                              <td className='px-2 py-3 mx-auto my-1 text-sm  border-r border-gray-700   bg-green-300 '>
                                26 ธ.ค. 65
                                <pre>(14:30)</pre>
                              </td>
