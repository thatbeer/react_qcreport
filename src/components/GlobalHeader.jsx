...
const GlobalHeader = () =>  {
    ...
    return (
        ...
        <Disclosure as="nav" className="bg-gradient-to-r from-cyan-500 to-blue-700">
        {({ open }) => (
            <>
            <div className="mx-auto w-screen px-2 sm:px-6 lg:px-8">
                ...
                <div className="absolute inset-y-0 right-0 flex items-center pr-2 
                    ...
                    >
                        ...
                        rounded-md bg-gray-200 py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                        <Menu.Item>
                            {({ active }) => (
                            <p
